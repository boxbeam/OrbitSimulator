		...
		submit.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				if (e.getButton() == 1) {
					...
					Body body = new Body(bodyMass, Main.plane.getPlaneLocation(location).subtractLocation(1000 * Main.plane.scale, 1000 * Main.plane.scale), velocity, color, Main.scheduler);
